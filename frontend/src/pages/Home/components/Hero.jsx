            ...
            <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-slate-950/60">
                ...
                <div
                    ...
                    <div className="relative z-10 px-6 py-12 sm:px-8 sm:py-16 lg:px-14">
                        ...
                        <h1 className="mt-6 text-4xl font-bold leading-tight bg-linear-to-r via-pink-300 from-violet-300 to-white bg-clip-text text-transparent sm:text-5xl md:text-6xl">
                            {slide.title}
                        </h1>
                    ...
                    {/* IMAGEM */}
                    <div className="relative min-h-75 sm:min-h-90 lg:h-full lg:min-h-105">
                        ...
                        <img
                            ...
                            className="
                                ...
                                w-full
                                object-cover
                                mask-[linear-gradient(to_left,black_50%,transparent_100%)]
                            "
                        />

                        <div className="absolute inset-0 bg-linear-to-r from-slate-950 via-slate-950/40 to-transparent lg:from-slate-950/70" />
